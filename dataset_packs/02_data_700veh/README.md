# Dataset pack: Scaled ~700 vehicles

โฟลเดอร์นี้เป็น Dataset ที่ “สเกลลงทั้งไฟล์” โดยคูณค่า `ปริมาณรถ(คัน/ชม.)` ทุกแถวด้วยค่าคงที่เดียวกัน เพื่อให้จำนวนรถที่ปล่อยรวมเหลือประมาณ 700 คัน (คงสัดส่วนเดิมทุกทางแยก/ช่วงเวลา/ประเภทรถ)
...
- `.\use_pack.bat 02_data_700veh build`
...
- Scaling factor (คูณกับ `ปริมาณรถ(คัน/ชม.)` ทุกแถว): 0.0011712813
- Total VPH หลังสเกล: 231.848
- Total vehicles หลังสเกล: 699.997
- เทียบกับปี 67: 0.117130%
