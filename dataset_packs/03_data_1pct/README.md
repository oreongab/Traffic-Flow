# Dataset pack: Scaled = 1% ของปี 67

โฟลเดอร์นี้เป็น Dataset ที่ “สเกลลงทั้งไฟล์” โดยคูณค่า `ปริมาณรถ(คัน/ชม.)` ทุกแถวด้วยค่าคงที่เดียวกันให้เหลือ 1% ของ Dataset ปี 67 (คงสัดส่วนเดิมทุกทางแยก/ช่วงเวลา/ประเภทรถ)
...
- Scaling factor (คูณกับ `ปริมาณรถ(คัน/ชม.)` ทุกแถว): 0.0100000000
- Total VPH หลังสเกล: 1,979.400
- Total vehicles หลังสเกล: 5,976.250
- เทียบกับปี 67: 1.000000%
